      ...
      <section>
        ...
        <div className="mt-2 overflow-hidden rounded-xl border border-border bg-surface shadow-card">
          <div className="overflow-x-auto">
            <table className="ui-table text-xs [&_td]:px-3 [&_td]:py-2 [&_th]:px-3 [&_th]:py-2">
              <thead>
                <tr>
                  <th>Date</th>
                  <th>Route</th>
              ...
              <tbody>
                {collectionRecords.map((record) => (
                  <tr key={record.id}>
                    <td className="font-semibold text-content">{record.date}</td>
                    <td>
                      <span className="rounded-md bg-primary-light px-2 py-1 font-mono text-xs font-semibold text-primary">
                        {record.route}
                      </span>
                    </td>
                    <td className="font-medium text-amber-800">{record.area}</td>
                    <td>
                    ...
                    <td className="font-semibold text-emerald-700">{record.stops}</td>
                    <td>
                      <StatusBadge variant="success" size="sm" className="px-1.5 py-0 text-[10px]">
          ...
          <div className="flex flex-col items-center justify-between gap-2 border-t border-border px-3 py-2 sm:flex-row">
